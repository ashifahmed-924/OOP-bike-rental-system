...
<html>
<head>
    <title>Register - Bike Rental and Ride-Sharing Platform</title>
    ...
    <div class="app-hero mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
                ...
                <p class="mb-0">Join as a rider to book and share rides, or as an operator to manage the bike fleet.</p>
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <div class="card app-card border-0">
                <div class="card-header text-center app-gradient-success">
                    ...
                    <form action="register" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="role" class="form-select" required>
                                ...
                                <option value="OPERATOR">Manage Bikes</option>
                            </select>
                        </div>
